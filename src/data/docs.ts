 ...
 *
 * Product versions come from './versions' — a generated file, so this one
 * never has to be edited when an application ships.
 */
...
export const docs: DocPage[] = [
  {
    ...
    blocks: [
      ...
      },
      {
        ...
        list: [
          `Zeqou/ — website (npm run dev, npm run build). Version ${versions.zeqou}.`,
          `Zeqou Harness/ — Electron app, v${versions.harness}, appId ai.zeqou.harness.`,
          `ZeqouXchat/ — Tauri 2 app, v${versions.xchat}, plus AIens/ Python experiments and dataset_ru.json.`,
          `ZeqouXTraining/ — Electron shell + pure-Python engine, v${versions.xtraining}, appId ai.zeqou.xtraining.`,
        ],
      },
      {
  ...
  },
  {
    ...
    blocks: [
      ...
      },
      {
        ...
        code: {
          lang: 'bash',
          code: 'npm install\nnpm run dev\nnpm run build\nnpm run preview\nnpm run versions        # re-read the product versions from the app repositories\nnpm run versions:check  # fail if this site disagrees with them',
        },
      },
      {
      ...
      },
      {
        ...
        list: [
          ...
          'Product versions: src/data/versions.ts — generated by npm run versions from each application repository, never typed by hand.',
